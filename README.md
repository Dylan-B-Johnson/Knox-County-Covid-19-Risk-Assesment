...
* This program should be more accurate for a number of reasons. The biggest reason is that the COVID-19 Event Risk Assessment Planning Tool was made early in the pandemic and still uses an assertainment consistent with that time. This program uses an assertainment bias of 2.7, which is roughly equivlant to the COVID-19 Event Risk Assessment Planning's assertainment bias, but scaled down proportionlly to the increase in testing since the COVID-19 Event Risk Assessment Planning was created.
