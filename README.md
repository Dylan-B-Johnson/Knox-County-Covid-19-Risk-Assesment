...
### No Longer Working:
As of December 6th, data is no longer getting logged properly and calculated risks are not being updated. This is due to an update to the County Health Website, I hope to fix this over Winter break, but I might not have the time.
